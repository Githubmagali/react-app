...
//dispatch es para poder enviar la accion
// en dispatch({type: 'AGREGAR_PRODUCTO_AL_CARRITO'}); le decimos al dispatch que tipo de accion queremos que el reducer haga
